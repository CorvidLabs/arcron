...
### REQ-keeper-009
Lateness SHALL be measured from the round the upkeep was last serviced, never from the round it was scheduled for, so that only the first execution of a catch-up burst can be escalated.
