...
Arcron's `execute` submits an inner app call with no foreign arrays, and the
...
class ResourceProbe(ARC4Contract):
    ...
    def __init__(self) -> None:
        ...
        # transaction once Arcron is in the middle.
    ...
    def report_budget(self) -> UInt64:
        ...
        Arcron upkeep it reports what a *target* gets, which is the number an
    ...
    def absorb(self, number: UInt64, text: arc4.String) -> UInt64:
        ...
        Arcron stores one blob and sends it as one app arg, and an ARC-4 method
    ...
    def report_caller(self) -> arc4.Address:
        ...
        Decides whether a target can pay the keeper itself: an Arcron-executed
    ...
    def reenter(self) -> UInt64:
        ...
        Arcron writes an upkeep's state before submitting the inner call, so a
