...
| **G4 · the decision** | after G3 | Announce, or do not. Freeze, or do not. Both written into [`../releases.md`](../releases.md) as the rc row asks, with the notifier's record as the evidence. An outside upkeep that survived a redeploy is evidence for *announce*, not a prerequisite for G2. Decided 2026-09-19: we will not wait for organic Algorand testers before using this ourselves. |
