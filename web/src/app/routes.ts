/**
 * Four destinations: the keeper registry, one upkeep, register, and Rain.
 *
 ...
 * registry. Network and app id stay in the query string; Rain reads its own
 * app id from the network config and does not steal `?app=`.
 */
